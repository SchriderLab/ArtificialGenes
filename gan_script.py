...
# idea: see if we can improve the quality of generated genomes (better in the sense that they better
# replicate characteristics like allele frequencies, LD, pairwise haplotype distances, pop structure) 
# by using more advanced GAN architectures (WGAN for example). 

# Then expand in two directions: 1) Try generating longer sequences 2) Try things like conditional and controllable generation
